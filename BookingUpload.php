...
<center>  
    <form action="BookingSendUpload.php" method="post" enctype="multipart/form-data">
        Upload a Foto Bukti:
        <input type="file" name="myfile" id="fileToUpload">
        <input class="btn info" name="id"  type="hidden" value="<?php echo $_GET["id"]; ?>" />        
        <input type="submit" name="submit" value="Upload Bukti" >
    </form>
</div>
