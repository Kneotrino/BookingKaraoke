 ...
 */
    ...
    class boking01Page extends Page
    {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'boking_room_id', 'boking_room_id_Room_Name', 'Boking Room Id'),
                new FilterColumn($this->dataset, 'boking_Harga', 'boking_Harga', 'Boking Harga'),
                ...
                new FilterColumn($this->dataset, 'boking_total', 'boking_total', 'Boking Total'),
                new FilterColumn($this->dataset, 'boking_deposit', 'boking_deposit', 'Boking Deposit'),
                new FilterColumn($this->dataset, 'boking_Bukti_Dp', 'boking_Bukti_Dp', 'Boking Bukti Dp'),
                new FilterColumn($this->dataset, 'boking_created', 'boking_created', 'Boking Created')
            );
        }
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('boking_room_id', 'boking_room_id_Room_Name', 'Boking Room Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            ...
            //
            $column = new NumberViewColumn('boking_Harga', 'boking_Harga', 'Boking Harga', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
            ...
            //
            $column = new DateTimeViewColumn('boking_waktu', 'boking_waktu', 'Boking Waktu', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            $column = new NumberViewColumn('boking_total', 'boking_total', 'Boking Total', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
            ...
            //
            $column = new NumberViewColumn('boking_deposit', 'boking_deposit', 'Boking Deposit', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
            ...
            //
            $column = new DownloadExternalDataColumn('boking_Bukti_Dp', 'boking_Bukti_Dp', 'Boking Bukti Dp', $this->dataset, '');
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            ...
            //
            $column = new DateTimeViewColumn('boking_created', 'boking_created', 'Boking Created', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new UploadFileToFolderColumn('Boking Bukti Dp', 'boking_Bukti_Dp', $editor, $this->dataset, false, false, 'BokingBukti', '%random%.%original_file_extension%', $this->OnFileUpload, false);
            ...
            $editColumn = new CustomEditColumn('Boking Created', 'boking_created', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Boking Room Id', 'boking_room_id', 'boking_room_id_Room_Name', 'multi_edit_boking_room_id_Room_Name_search', $editor, $this->dataset, $lookupDataset, 'Room_Id', 'Room_Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $editColumn = new CustomEditColumn('Boking Harga', 'boking_Harga', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $editColumn = new CustomEditColumn('Boking Total', 'boking_total', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $editColumn = new CustomEditColumn('Boking Deposit', 'boking_deposit', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Room_Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Boking Room Id', 'boking_room_id', 'boking_room_id_Room_Name', 'insert_boking_room_id_Room_Name_search', $editor, $this->dataset, $lookupDataset, 'Room_Id', 'Room_Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
    ...
    try
    {
        $Page = new boking01Page("boking01", "boking.php", GetCurrentUserPermissionSetForDataSource("boking01"), 'UTF-8');
        $Page->SetTitle('Boking');
        $Page->SetMenuLabel('Boking');
