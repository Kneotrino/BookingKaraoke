 ...
 */
    ...
    class boking01Page extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('boking_room_id_edit');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('boking_room_id_edit');
            ...
            $editColumn = new UploadFileToFolderColumn('Boking Bukti Dp', 'boking_Bukti_Dp', $editor, $this->dataset, false, false, '', '%original_file_name%', $this->OnFileUpload, false);
    ...
    try
    {
        $Page = new boking01Page("boking01", "boking01.php", GetCurrentUserPermissionSetForDataSource("boking01"), 'UTF-8');
